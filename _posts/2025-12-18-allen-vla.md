...
title_zh: "使用 SoArm-101 的视觉-语言-动作模型进行机器人操作"
subtitle: "End-to-end imitation learning with LeRobot framework"
subtitle_zh: "使用LeRobot框架的端到端模仿学习"
excerpt_zh: "探索将最先进的视觉-语言-动作（VLA）模型应用于使用 SoArm-101 机械臂的机器人操作任务。"
...
|-------|------------|---------|
| **Framework** | ![LeRobot](https://img.shields.io/badge/🤗_LeRobot-FF9D00?style=flat-square) | Robot learning framework |
...
| **Dataset** | ![Hugging Face](https://img.shields.io/badge/🤗_Hub-FFD21E?style=flat-square) | Dataset & model hosting |
...
1. **Camera Server Thread**: MJPEG streaming server (Webcam or RealSense) that serves frames independently at 30 FPS, decoupled from the control loop to prevent frame drops during servo communication
...
1. **Expand Model Coverage**: Implement Pi-Zero-Point-Five (π0.5) architectures and further optimize π0 performance
...
[在 GitHub 上查看此项目](https://github.com/nu-jliu/allen-vla)

[Hugging Face Hub 上的数据集](https://huggingface.co/datasets/jliu6718/lerobot-so101-act) | [Hugging Face Hub 上的训练模型](https://huggingface.co/jliu6718/lerobot-so101-act)
